            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <p>Tanggal Berangkat : <b><?php echo hari_indo(date('N',strtotime($jadwal['tgl_berangkat_jadwal']))).', '.tanggal_indo(date('Y-m-d',strtotime(''.$jadwal['tgl_berangkat_jadwal'].''))); ?></b></p>
